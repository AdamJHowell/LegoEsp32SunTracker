...
int declinationStopPin = 16;	// The GPIO connected to the declination limit switch.
int inclinationStopPin = 17;	// The GPIO connected to the inclination limit switch.
